...
from .announcements_admin import router as announcements_admin_router # NEW
...
admin_router.include_router(announcements_admin_router, prefix="", tags=["Admin - Announcements"]) # No prefix, routes will be /admin/announcements etc.