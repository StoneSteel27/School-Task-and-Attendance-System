...
from app.schemas import teacher_attendance as teacher_attendance_schema

router = APIRouter()

@router.post("/attendance/check-in", response_model=teacher_attendance_schema.TeacherAttendanceInDB)
def check_in(
    *,
    db: Session = Depends(get_db),
    attendance_data: attendance_schema.AttendanceRequest,
...
@router.post("/attendance/check-out", response_model=teacher_attendance_schema.TeacherAttendanceInDB)
def check_out(
    *,
    db: Session = Depends(get_db),
    attendance_data: attendance_schema.AttendanceRequest,
