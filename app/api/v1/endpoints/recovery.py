...
from app.schemas.recovery_code import RecoveryCodesResponse, RecoveryCodeCreate, RecoveryCodeLoginRequest # ADDED THIS LINE
from app.schemas.token import Token # ADDED THIS LINE
...
@router.post("/recovery/login", response_model=schemas.token.Token)
def recovery_login(
    *,
    db: Session = Depends(get_db),
    login_data: schemas.recovery_code.RecoveryCodeLoginRequest,
):
    """
