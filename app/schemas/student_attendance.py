...
from .user import User as UserSchema  # For student and teacher info
from .school_class import SchoolClassBase as SchoolClassInfoSchema  # For basic class info
